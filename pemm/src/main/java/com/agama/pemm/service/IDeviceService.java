...
public interface IDeviceService extends IBaseService<Device, Integer> {
	 ...
	 */
	public void addDeviceForScan(List<Integer> gitInfoIdList, List<Map<String, Object>> deviceIndexList);
	...
	public Page<Device> searchListByAreaInfoId(Integer areaInfoId, Page<Device> page, List<PropertyFilter> filters);
	 ...
	 * @param deviceType
	 */
	public List<Device> getListByGitInfoIdAndDeviceType(Integer gitInfoId, DeviceType deviceType);
