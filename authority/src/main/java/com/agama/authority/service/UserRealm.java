...
import com.agama.authority.service.impl.PermissionServiceImpl;
import com.agama.authority.service.impl.UserServiceImpl;
import com.agama.authority.utils.CaptchaException;
import com.agama.authority.utils.UsernamePasswordCaptchaToken;
...
public class UserRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		//赋予权限
		for(Permission permission:permissionService.getPermissions(user.getId(),null)){
