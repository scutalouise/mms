...
function addRule(){
	...
	rule_d=$("#rule_dlg").dialog({
		...
		width:548,
		height : "auto",
		href:ctx+"/system/alarmRule/addForm?deviceInterfaceType="+checkedDeviceInterfaceType,
		maximizable:true,
		modal:true,
		buttons:[{
			text:"确认",
...
function updateRule(){
	...
	rule_d=$("#rule_dlg").dialog({
		...
		width:548,
		height : "auto",
		href:ctx+"/system/alarmRule/updateForm/"+row.id+"/"+checkedDeviceInterfaceType,
		maximizable:true,
		modal:true,
		buttons:[{
			text:"确认",
