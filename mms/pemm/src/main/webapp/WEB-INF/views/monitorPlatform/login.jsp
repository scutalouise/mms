...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${ctx }/static/monitorPlatform/css/style.css">
    <link rel="stylesheet" type="text/css" href="${ctx }/static/monitorPlatform/css/metro.css">
    <script src="${ctx }/static/monitorPlatform/js/jquery.min.js"></script>
...
<body style="background: url('${ctx }/static/monitorPlatform/images/bj_11.jpg') top center no-repeat;background-size:100% 100%;">
    ...
    <div class="top-banner metro-layout" >
        ...
        <div class="header">
            <div class="logintitle">
                ...
                <div class="logintitle_mid"><h1>动力环境数据采集监控平台</h1></div>
                <div class="logintitle_bottom" style="color: black;">Monitoring System of Power and Environment</div>
            </div>
        </div>
        <div class="bottom" style="border-radius:10px;">
            <form id="loginForm" action="${ctx}/m/login" method="post" style="padding: 10px;" onsubmit="return subLogin()">
