...
<body style="background-repeat: repeat;overflow-y:hidden;min-width:1280px;min-height: 700px;">
	<div style="width:1280px;min-width:768px;margin:auto;">
		<div class="login_top" >
			<div class="login_title" style="width: 690px;">
				...
				<span style="color:#6F6C6C;float: left;margin-left: 10px;">动力环境监控系统-监控中心</span>
			</div>
		</div>
		<div class="login_main_null" style="height:475px;">
			<div style="float:right;width:600px;">
				<form id="loginForm" action="${ctx}/d/login" method="post"  onsubmit="return subLogin()">
		...
		<div class="login_footer" style="clear:both;height:60px;width:inherit;text-align:center;font-size:13px;font-family: '微软雅黑','宋体',Arial, sans-serif;">
			<p style="color:#6F6C6C;">版权所有©四川阿特申商贸有限公司<span style="padding: 0 20px">|</span>成都申控物联科技有限公司<span style="padding: 0 20px;">|</span >Version:&nbsp;&nbsp;<span style="font-weight:900;">SK_DHRS_NX0100</span></p>
		</div>
	</div>
	<c:choose>
