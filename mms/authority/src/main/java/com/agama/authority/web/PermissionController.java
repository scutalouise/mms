...
public class PermissionController extends BaseController{
	...
	@ResponseBody
	public List<Permission> myPermissionDate(String code) {
		List<Permission> permissionList=permissionService.getPermissions(UserUtil.getCurrentUser().getId(), code);
		return permissionList;
	}
	...
	public List<Permission> otherPermissionDate(@PathVariable("userId") Integer userId) {
		List<Permission> permissionList=permissionService.getPermissions(userId,null);
		return permissionList;
	}
