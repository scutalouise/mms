package com.agama.das.protocol.snmp.mib.firewall;
...
/**@Description:迪普防火墙MIB库中监控的oid枚举
 * @Author:佘朝军
 * @Since :2015年12月31日 下午4:32:57
 */
public enum DPMib implements MibOID{
	...
	private DPMib(String oid, int mode) {
		this.oid = oid;
		this.mode = mode;
	}
