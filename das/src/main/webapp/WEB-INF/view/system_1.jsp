...
<head lang="en">
    <meta charset="UTF-8">
    <title>系统配置中心—设置数据交互时间</title>
    <link href="static/css/system_1.css" rel="stylesheet" type="text/css">
    <style type="text/css">
    	.tabcontent{
    		min-height:480px;
    		height:auto;
    ...
    <script type="text/javascript">
    	$(function(){
    		...
    		$.ajax({
    			url : "/das/config/properties/quartzCron/key/interactTrigger",
    			type : "get",
    			dataType : "json",
    			success : function(data) {
    				var value = data.interactTrigger;
    		...
    		$("#submit").click(function(){
    			...
    			$.ajax({
    				url : "/das/config/properties/quartzCron/key/interactTrigger/value/" + value,
    				type : "PUT",
    				dataType : "json",
    				error : function(){
    					alert("请求异常！");
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="main_right_1">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="nav nav-pills nav-justified">
                            <li role="presentation" class="active"><a href="/das/system1">设置数据交互时间</a></li>
                        ...
                        <ul class="media-list">
                            <li class="media">
                                <div class="media-left">
                                    <a><img class="media-object"  src="static/images/xx/3_xx_shujujiaohu.png"></a>
                                </div>
                                <div class="media-body">
                                    <div class="alert alert-info" role="alert" id="tb_2">
                                        <strong>请设置数据交互时间（分钟）</strong></div>
                                </div>
                            </li>
                        </ul>
                    </div>
